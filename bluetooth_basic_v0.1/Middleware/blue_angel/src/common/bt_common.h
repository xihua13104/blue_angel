...
#define BT_FREE_HCI_PACKET_WITH_NODE(memory_type, p)  (bt_memory_free_packet(memory_type, (uint8_t *)p - sizeof(bt_hci_packet_t)))

#define BT_GET_NODE_FROM_HCI_SPEC_PACKET(p)    ((bt_linknode_t *)((uint8_t *)p - sizeof(bt_hci_packet_header_t)))
#define BT_GET_HCI_SPEC_PACKET_FROM_NODE(node) ((bt_hci_spec_packet_t *)((uint8_t *)p + sizeof(bt_hci_packet_header_t)))
